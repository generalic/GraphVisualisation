...
public class PlutoExplorer extends Application {
    ...
    private static final String IMAGE_URL =
        "http://www.nasa.gov/sites/default/files/thumbnails/image/global-mosaic-of-pluto-in-true-color.jpg";
    ...
    private void shift(ImageView imageView, Point2D delta) {
        ...
        imageView.setViewport(
            new Rectangle2D(minX, minY, viewport.getWidth(), viewport.getHeight()));
    }
