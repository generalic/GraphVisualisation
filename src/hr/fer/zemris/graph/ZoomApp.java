 ...
 * If you magnify to {@link #MAX_SCALE}, an interesting problem occurs when you try to zoom back to
 * {@link #MIN_SCALE}. In the beginning
 * you will see that the {@code scrollPane} scrolls and consumes the {@code ScrollEvent} until we
 * have scrolled to the bottom of the window.
 * Once the bottom of the window is reached, it behaves as expected (or at least as I was
 * expecting).
 *
